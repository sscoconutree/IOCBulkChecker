...
<h3>v1.1</h3>
* Fixed URL analysis by performing POST request to the server first before proceeding with the GET request to get the report. This is to ensure flexibility of URL inputs for analysis.
